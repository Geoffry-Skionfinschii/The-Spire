...
scoreboard players operation #temp_prog G_Temporary *= #20 G_Constants
scoreboard players operation #temp_prog G_Temporary += #11999 G_Constants
...
scoreboard players operation #food_prog G_Temporary *= #20 G_Constants
scoreboard players operation #food_prog G_Temporary += #9999 G_Constants
scoreboard players operation #food_prog G_Temporary /= #10000 G_Constants

execute if score @s G_AmbTemperature matches 1..20 run scoreboard players set #temp_change_dir G_Temporary 4
execute if score @s G_AmbTemperature matches 21..40 run scoreboard players set #temp_change_dir G_Temporary 5
execute if score @s G_AmbTemperature matches 41.. run scoreboard players set #temp_change_dir G_Temporary 6
execute if score @s G_AmbTemperature matches 0 run scoreboard players set #temp_change_dir G_Temporary 3
execute if score @s G_AmbTemperature matches -20..-1 run scoreboard players set #temp_change_dir G_Temporary 2
execute if score @s G_AmbTemperature matches -40..-21 run scoreboard players set #temp_change_dir G_Temporary 1
execute if score @s G_AmbTemperature matches ..-41 run scoreboard players set #temp_change_dir G_Temporary 0
...
# Re-enable to render current bar design
