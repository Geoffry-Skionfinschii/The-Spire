...
summon armor_stand ~ ~-1 ~1 {ArmorItems:[{},{},{id:"leather_chestplate",Count:1b},{id:"zombie_head",Count:1b}],DisabledSlots:4144943,Invisible:1b,Invulnerable:0b,NoGravity:true,NoBasePlate:1b,ShowArms:1b,Pose:{Body:[278f,0f,0f],Head:[317f,0f,0f],LeftArm:[270f,0f,0f],RightArm:[270f,0f,0f]},Tags:["DEAD_BODY","DEAD_BODY_HEAD","sdfgBFBYUfbsef"]}
...
data modify entity @e[tag=DEAD_BODY,tag=DEAD_BODY_HEAD,tag=sdfgBFBYUfbsef,limit=1] ArmorItems[3] set from entity @e[type=item,nbt={Item:{tag:{GetNameItemLootTable:1b}}},limit=1] Item

#effect give @e[tag=DEAD_BODY,tag=DEAD_BODY_PIG,tag=sdfgBFBYUfbsef,limit=1] invisibility 999999 0 true
