...
execute if score @s G_PlayerMaxHP matches 2001.. run scoreboard players set @s G_PlayerMaxHP 2000
...
#scoreboard players operation #max_hp_in_hearts G_Temporary = @s G_PlayerMaxHP
#scoreboard players operation #max_hp_in_hearts G_Temporary += #99 G_Constants
#scoreboard players operation #max_hp_in_hearts G_Temporary /= #100 G_Constants

function the_spire:game/states/2/state/max_health_controller/set_max_hp
