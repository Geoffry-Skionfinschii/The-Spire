...
execute if score $TH_VeryFreezingTick G_Timers matches 0.. run scoreboard players set $TH_VeryFreezingTick G_Timers 0
execute if score $TH_FreezingTick G_Timers matches 10.. run scoreboard players set $TH_FreezingTick G_Timers 0
