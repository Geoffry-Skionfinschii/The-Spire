...
execute if entity @a[distance=..20] run data modify entity @s AngerTime set value 10
execute if entity @a[distance=..20] run data modify entity @s AngryAt set from entity @p UUID
